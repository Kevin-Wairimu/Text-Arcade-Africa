      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-900 max-w-3xl mx-auto text-lg leading-relaxed"
          >
            A collective of passionate experts dedicated to transforming the
            African media landscape through innovation, data, and design
            thinking.
          </motion.p>
        </motion.div>
          ...
          {team.map((person, i) => (
            ...
            >
              <img
                src={person.img}
                alt={person.name}
                className="h-32 w-32 rounded-full mx-auto object-cover ring-4 ring-white shadow-lg mb-6"
              />
              <h3 className="font-bold text-2xl text-[#2E7D32] mb-1">
                {person.name}
              </h3>
              <p className="text-[#2E7D32] font-medium text-sm uppercase tracking-wider mb-3">
                {person.role}
              </p>
              ...
              {person.bio && person.bio !== "-" && (
                <p className="text-gray-800 text-sm leading-relaxed border-t border-[#2E7D32]/20 pt-4 mt-2 flex-grow">
                  {person.bio}
                </p>
              )}
              ...
              <div className="flex items-center justify-center gap-6 mt-6 pt-4 border-t border-[#2E7D32]/20">
                {Object.entries(person.socials).map(([platform, url]) => (
                  <a
                    ...
                    className="text-[#2E7D32] hover:text-[#14532D] transition-transform duration-300 hover:scale-110"
                  >
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-900 max-w-2xl mx-auto text-lg mb-12"
          >
            We are proud to collaborate with leading organizations to drive
            media innovation across the continent.
          </motion.p>
        </motion.div>
          ...
          {partners.map((partner, i) => (
            ...
            >
              <div className="h-20 w-20 bg-[#2E7D32]/20 rounded-full flex items-center justify-center mb-4 transition">
                <span className="text-white font-bold text-xl transition">
                  {partner.logo}
                </span>
              </div>
              <h3 className="font-semibold text-[#2E7D32] transition">
                {partner.name}
              </h3>
            </motion.div>
          ))}
